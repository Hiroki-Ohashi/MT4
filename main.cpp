...
int WinApp::WindowProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam);
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	hr = dxgiFactory->CreateSwapChainForHwnd(commandQueue, WinApp::hwnd, &swapChainDesc, nullptr, nullptr, reinterpret_cast<IDXGISwapChain1**>(&swapChain));
	assert(SUCCEEDED(hr));
